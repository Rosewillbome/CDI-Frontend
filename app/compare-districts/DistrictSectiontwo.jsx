    ...
    <div className="h-[330px] bg-gray-50 rounded-xl border border-gray-200 mb-6">
      <div className="w-full h-full flex items-center justify-center text-gray-500">
        <UgandaMap
          ...
          imageCintainerId={"district-section-two-map-img"}
          mapConatinerId={"district-section-two-map"}
        />
      </div>
    </div>
  );
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6">
        ...
        <div className="flex items-center gap-4 flex-wrap">
          ...
          >
            ...
            {showYears()?.map((year, index) => (
              <option key={index} className="bg-[#fbfcfc]">
                {year}
              </option>
            ))}
          </select>
          ...
          >
            ...
            {months?.map((month, index) => (
              <option key={index} className="bg-[#f7f8f8]">
                {month[0]}
              </option>
            ))}
          </select>
      ...
      <div className="space-y-6">
        ...
        />
        <Section
          chart_id={"District_section_20981"}
          indicator={"VDI"}
          timerange={timerangeTwo}
          // month={monthOne}
          district={districtTwo}
